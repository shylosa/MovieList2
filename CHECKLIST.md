...
- [ ] **[internal/storage/storage.go / InitSchema]** Розбити `PRAGMA journal_mode`, `PRAGMA synchronous`, `PRAGMA busy_timeout` на окремі `db.db.ExecContext(ctx, "PRAGMA ...")` виклики. Перевіряти `err` кожного.
