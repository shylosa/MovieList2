...
export function ConfirmTMDBCandidate(arg1) {
  return window['go']['main']['App']['ConfirmTMDBCandidate'](arg1);
}
...
export function GetTMDBCandidateDetails(arg1) {
  return window['go']['main']['App']['GetTMDBCandidateDetails'](arg1);
}
...
export function SyncToGitHub() {
  return window['go']['main']['App']['SyncToGitHub']();
}
